 ...
 * Author        : xinchengxin
 * Last Modified : 2017.08.31, 16:23:19
 ********************************************************************************/
#include <gtk/gtk.h>
#include "main.h"
...
/********************************************************************************
 * Description : After user clicked the signup button in signup window, signup.
 * Prameter    : Function is not completed.
 * Return      : void
 * Side effect : Function is not completed.
 * Author      : xinchengxin
...
/********************************************************************************
 * Description : After user clicked the signup button in signup window, destroy the signup window, submit the data to server and create a signin window.
...
/********************************************************************************
 * Description : After user clicked the signup button in signin window, destroy the signin window and create a signup window.
...
/********************************************************************************
 * Description : Create a signin window.
 * Prameter    : None.
 * Return      : void
 * Side effect : None.
 * Author      : xinchengxin
...
/********************************************************************************
 * Description : Create a signup window.
 * Prameter    : None.
 * Return      : void
 * Side effect : None.
 * Author      : xinchengxin
...
/********************************************************************************
 * Description : Start the uTalk Application.
...
/********************************************************************************
 * Description : the main funcation, creating this application.
