...
extern int request_friends_list_to_server (char *username, int *friends_num, const char *friends_list[], const char *msg_list[]);
extern int search_friends_to_server (const char *search_string, int *friends_num, const char *friends_name[]);
extern int send_friend_request_to_server (const char *name);
extern int search_friends_to_server (const char *search_string, int *friends_num, const char *friends_name[]);
